...
# Logged In Layout
    ...
    if st.session_state.current_plan == "pro":
        st.markdown("""
        <div class="qr-card">
            <h3 style="color: #7c3aed !important; margin:0;">⚡ PRO PLAN GATEWAY ACTIVE</h3>
            <p style="color: #4b5563 !important; font-size: 0.9rem; margin-bottom: 10px;">Scan to complete verification context</p>
            ...
            <div style="font-size: 0.8rem; opacity: 0.8;">Secure UPI Network Gateway Protocol Enabled</div>
        </div>
        """, unsafe_allow_html=True)
